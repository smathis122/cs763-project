...
# Configuration
appConf = {
    "OATH2_CLIENT_ID" : "95479501580-7om6n792bbd8em6l76a2sf14a8dg2h80.apps.googleusercontent.com",
    "OATH2_CLIENT_SECRET" : "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",
    "OATH2_META_URL" : "https://accounts.google.com/.well-known/openid-configuration",
...
oauth.register("GearToGoApp",
               client_id = appConf.get("OATH2_CLIENT_ID"),
               client_secret = appConf.get("OATH2_CLIENT_SECRET"),
